...
<p align="center">
  <video src="https://github.com/TechnomancerIncrease/DepthVLM-855/772c15d7-2fac-4bbb-9874-112073feefe7"
         width="80%"
         autoplay
         muted
         loop
...
```bash
git clone https://github.com/TechnomancerIncrease/DepthVLM-855.git
cd DepthVLM-855
python setup.py
```
...
<!-- Last updated: 2026-06-06 15:41:16 -->
